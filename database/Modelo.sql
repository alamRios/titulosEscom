...
CREATE TABLE IF NOT EXISTS `escomTitulos`.`estudiante` (
  ...
  `estudiante_nombre` VARCHAR(45) NULL,
  `esudiante_boleta` VARCHAR(45) NULL,
  `estudiante_pass` VARCHAR(50) NULL,
  PRIMARY KEY (`idestudiante`),
  UNIQUE INDEX `esudiante_boleta_UNIQUE` (`esudiante_boleta` ASC))
ENGINE = InnoDB;
