...
CREATE TABLE IF NOT EXISTS `escomTitulos`.`personal` (
  ...
  `personal_puesto` VARCHAR(50) NULL,
...
CREATE TABLE IF NOT EXISTS `escomTitulos`.`evento_estudiante_foto` (
  ...
  `evento_estudiante_foto_folder` VARCHAR(45) NULL,
  `evento_estudiante_foto_valido` BIT NULL,
  `evento_estudiante_foto_src` VARCHAR(45) NULL,
  `evento_estudiante_foto_created_at` DATETIME NULL,
